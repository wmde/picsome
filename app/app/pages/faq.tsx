    ...
    <Grid>
      <Content>
        ...
        >
          ...
          <p>
            <UT _str="Eine Übersicht der unterschiedlichen Lizenzbedingungen findest du in der Navigation unter <a href='https://picsome.org/about-licenses' target='_blank'>“Über Bildlizenzen”</a>. Wenn du dich ausführlicher über die verschiedenen Creative Commons Lizenzen informieren möchtest, hilft ein Blick in die Broschüre <a href='https://commons.wikimedia.org/wiki/File:Open_Content_-_Ein_Praxisleitfaden_zur_Nutzung_von_Creative-Commons-Lizenzen.pdf' target='_blank'>“Open Content - Ein Praxisleitfaden zur Nutzung von Creative-Commons-Lizenzen“</a>" />
          </p>
        </Accordion>
        ...
        >
          ...
          <p>
            <UT _str="Auf der Startseite findest du die Kategorie <a href='https://picsome.org/resources/tagfree' target='_blank'>“Bildersuche verbessern”</a>. Hier befinden sich alle Bilder, die sich freuen, von dir mit Tags versehen zu werden. So kannst du dabei helfen, die Suche für alle zu verbessern!" />
          </p>
        </Accordion>
        ...
        >
          <p>
            <UT _str="Wenn du freigegebene Inhalte nutzen möchtest, bist du verpflichtet, die entsprechenden Lizenzbedingungen einzuhalten und einen Lizenzhinweis anzugeben. Den korrekten Lizenzhinweis für dein Bild kannst du mithilfe des <a href='https://picsome.org/check' target='_blank'>Lizenzcheckers</a> erhalten." />
          </p>
          <p>
