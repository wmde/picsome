          ...
          <Grid>
            ...
            <div className={styles.overview__table}>
              ...
              <div className={styles.overview__tableInner}>
                {/* CC 0 */}
                <div className={styles.overview__tableRow}>
                ...
                {/* <div className={styles.overview__tableRow}>
                  ...
                  <div className={styles.overview__tableFeatures}>
                    <div>
                      <CheckCircle />
                      <span><T _str="Kommerziell nutzen" /></span>
                    </div>
                    <div>
                      <CheckCircle />
                      <span><T _str="Teilen" /></span>
                    </div>
                    <div>
                      <CheckCircle />
                      <span><T _str="Bearbeiten" /></span>
                    </div>
                  </div>
                  <div className={styles.overview__tableTerms}>
                    <div>
                      <WarningCircle />
                      <span><T _str="Namensnennung" /></span>
                    </div>
                    <div>
                      <WarningCircle />
                      <span><T _str="Weitergabe unter gleichen Bedingungen" /></span>
                    </div>
                    <div>
                      <ForbiddenCircle />
                      <span><T _str="Keine Bearbeitung" /></span>
                    </div>
                    <div>
                      <ForbiddenCircle />
                      <span><T _str="Keine kommerzielle Nutzung" /></span>
                    </div>
                    <div>
                      <ForbiddenCircle />
                      <span><T _str="Keine Bearbeitung" /></span>
