...
import { Wikipedia, WikiCommons, Flickr, Openverse } from "app/core/components/RepositoryLogos"
import { generateAttribution } from "../../core/utils"
...
const Check: BlitzPage<ServerSideProps> = (props: ServerSideProps) => {
  ...
  const attribution = generateAttribution(props.image)
    ...
    <>
      <InputStageModule
        ...
        copy={
          <>
            <p>
              <T _str="Füge eine Bild-URL ein, und wir erstellen einen Lizenzhinweis für dich." />
            </p>
            <p>
              <UT
                _inline
                _str="<b>Tipp:</b> Die Bild-URL beginnt mit <mark>https://commons.wikimedia.org/wiki/File:</mark> für Bilder von Wikimedia Commons und mit <mark>https://de.wikipedia.org/wiki/</mark> für Bilder von Wikipedia."
              />
            </p>
            <p>
