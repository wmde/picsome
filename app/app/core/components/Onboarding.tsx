...
import { Image, Routes } from "blitz"
...
export const Onboarding = (props: OnboardingProps) => {
  ...
  const OnboardingSlides = [
    ...
    {
      headline: "Bilder mit eigenen Tags versehen",
      content: (
        <>
          <UT
            _str="<p>Bilder können mit Tags versehen werden, um diese in der Suche besser auffindbar zu machen und Bilder untereinander zu verknüpfen. Wenn du Bilder zu picsome hinzufügst, kannst du direkt auch passende Tags ergänzen, so ist das Tagging quasi schon erledigt und dein Bild kann besser von anderen gefunden werden.
  </p>"
          />
    ...
    {
      headline: "Suche nach (mehreren) Tags",
      content: (
        <>
          <UT
            _str="<p>picsome setzt <a href='https://www.wikidata.org/wiki/Wikidata:Introduction/de' target='_blank' />Wikidata</a> zum Suchen und Taggen der Bilder ein. Wenn du einen Suchbegriff in die Suchmaske eingibst, schlägt picsome dir automatisch einen Wikidata-Begriff vor, den du mit “Enter” bestätigen und so die Suche starten kannst. </p><p>Um noch genauere Suchergebnisse zu erhalten, kannst du picsome mithilfe mehrerer Tags durchsuchen: Einfach das gewünschte Tag ins Suchfeld eingeben, mit Enter bestätigen und weitere Tags ergänzen. Per Klick auf das kleine Kreuz lassen sich einzelne Tags auch wieder ganz leicht entfernen. 
  </p>"
          />
    ...
    {
      headline: "Bilder alleine oder gemeinsam sammeln",
      content: (
        <>
          <T
            _str=" {image} "
    ...
    {
      headline: "Lizenzbedingungen prüfen",
      content: (
        <>
          <T
            _str=" {image} "
