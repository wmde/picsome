...
export default function ReportMail(props: any) {
  ...
  const preview = t("A resource was reported")
  const newReport = t("Neuer Report")
  const check = t("Ressource ansehen")
        ...
        <MjmlSection>
          <MjmlColumn>
            ...
            <MjmlText font-size="14px" line-height="18px">
              {`https://picsome.org/resource/${props.resourceId}`}
              <br />
              {props.reason}
              <br />
              {props.message}
        ...
        <MjmlSection>
          <MjmlColumn>
            <MjmlButton
              ...
              href={`https://picsome.org/resource/${props.resourceId}`}
            >
              {check}
            </MjmlButton>
          </MjmlColumn>
